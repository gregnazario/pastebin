...
export class PasswordValidator {
  ...
  private static readonly COMMON_PASSWORDS = [
    ...
    'dragon123', 'baseball123', 'football123', 'qwerty123', 'master123',
    'michael123', 'shadow123', 'superman123', 'hello123', 'charlie123',
  ];
  ...
  static validate(password: string): PasswordValidationResult {
    ...
    if (entropy < this.MIN_ENTROPY) {
      errors.push(`Password entropy is too low (${entropy.toFixed(1)} bits, need at least ${this.MIN_ENTROPY})`);
    }
