...
- Runtime API base URL must be a root origin (for example `https://pastebin.sed.fyi`), not a path URL.
...
- Default runtime API base is `Production` so native and web backends match out of the box.
