/**
 * Cross-platform cryptographic conformance vectors.
 *
 * These vectors are generated from the current web implementation and must
 * decrypt consistently in Swift, Kotlin, and web runtimes.
 */
